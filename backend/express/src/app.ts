...
const adminData = {
  ...
  activities: [
    ...
    { event: "Inventory updated for Urban Trek Backpack", owner: "Inventory Bot", time: "18 min ago" },
  ...
  inventory: [
    { product: "Urban Trek Backpack", current: 18, reserved: 6, warehouse: "North", updated: "Today" },
    { product: "Noise Shield Headphones", current: 84, reserved: 12, warehouse: "West", updated: "Today" },
    { product: "Everyday Ceramic Bottle", current: 0, reserved: 0, warehouse: "South", updated: "Yesterday" },
  ],
  orders: [
    { id: "SW-1048", customer: "Aarav Sharma", total: "$164.00", payment: "Paid", status: "Processing" },
    { id: "SW-1047", customer: "Nina Patel", total: "$32.00", payment: "Paid", status: "Delivered" },
    { id: "SW-1046", customer: "Liam Walker", total: "$129.00", payment: "Pending", status: "Pending" },
  ],
  reviews: [
    { product: "Noise Shield Headphones", rating: "5/5", customer: "Nina Patel", status: "Approved" },
    { product: "Urban Trek Backpack", rating: "4/5", customer: "Aarav Sharma", status: "Pending" },
    { product: "Everyday Ceramic Bottle", rating: "2/5", customer: "Liam Walker", status: "Reported" },
  ],
  customers: [
  ...
  mcpTools: [
    { name: "search_products", status: "Enabled", permissions: "Catalog read", lastUsed: "2 min ago" },
    ...
    { name: "recommend_products", status: "Disabled", permissions: "AI read", lastUsed: "Yesterday" },
  ],
  analytics: [
